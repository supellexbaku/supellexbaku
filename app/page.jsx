    ...
    <main className="min-h-screen bg-slate-950 text-white overflow-hidden">
      ...
      <section id="kredit" className="px-5 py-24 bg-white text-slate-900">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <a href="https://wa.me/994554131658" target="_blank" className="inline-block mt-8 px-8 py-4 rounded-2xl bg-blue-600 text-white font-bold shadow-xl hover:bg-blue-700 transition">
      ...
      <section id="elaqe" className="max-w-7xl mx-auto px-5 py-24 text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          <a href="https://wa.me/994554131658" target="_blank" className="px-8 py-4 rounded-2xl bg-green-500 text-white font-bold">
            WhatsApp
          </a>

          <a href="https://t.me/supellex_baku_bot" target="_blank" className="px-8 py-4 rounded-2xl bg-sky-500 text-white font-bold">
            Telegram
          </a>
        </div>
      </section>
      ...
      <div className="fixed right-5 bottom-5 z-50 flex flex-col gap-3">
        <a href="https://wa.me/994554131658" target="_blank" className="w-14 h-14 rounded-full bg-green-500 flex items-center justify-center text-2xl shadow-2xl">
          ☘️
        </a>

        <a href="https://t.me/supellex_baku_bot" target="_blank" className="w-14 h-14 rounded-full bg-sky-500 flex items-center justify-center text-2xl shadow-2xl">
          ✈️
        </a>
      </div>
      ...
      <div className="fixed left-5 bottom-5 z-50">
        <button className="w-16 h-16 rounded-full bg-blue-600 hover:bg-blue-700 text-white text-3xl shadow-2xl transition">
          🤖
        </button>
      </div>
